                    ...
                    <div class="overview-content">
                        <div class="content left-content">
                            ...
                            <ul class="services-list">
                                ...
                                <li><span><i class="flaticon-check-mark"></i> Sekolah (SMA / SMK / SMP / SD / TK / Yang sederat lainnya)</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Pengusaha UMKM</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Personal / Pribadi</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Toko - Toko Retail</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Toko - Toko Makanan / Minuman</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Rumah Makan / Warung</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Organisasi Internal Pendidikan</span></li>
                                <li><span><i class="flaticon-check-mark"></i> Organisasi External / Umum</span></li>
                            </ul>
                        </div>
                    </div>
		...
		<section class="funfacts-area ptb-70 pt-0">
			<div class="container">
				...
				<div class="contact-cta-box">
					<h3>Memiliki pertanyaan terkait ini?</h3>
					<p>Jangan ragu untuk mencoba hubungi kami</p>
					<a target="blank" href="https://api.whatsapp.com/send/?phone=6282295603115&text=Izin%20Bertanya%20terkait%20Proyek%20yang%20sudah%20dikerjakan&type=phone_number&app_absent=0" class="btn btn-primary">Hubungi Kami</a>
				</div>
