...
<?php include 'templates/nav.php'; ?>
        ...
        <div class="page-title-area item-bg1 jarallax" data-jarallax='{"speed": 0.3}'>
            <div class="container">
                <div class="page-title-content">
                    <h2>Portofolio</h2>
                    <p>Beberapa proyek yang telah kami kerjakan</p>
                </div>
            </div>
        </div>
        <!-- End Page Title Area -->
		...
		<section class="blog-area ptb-70">
			<div class="container">
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: September 15, 2019
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">Ciungwanara Adventure</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: Maret 15, 2021
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">Bubuk Cabai Pa Abdul</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: Februari 9, 2022
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">BnC Cookies Bandung</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: Juni 2, 2023
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">Genetic Wear Bandung</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: September 25, 2023
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a target="_blank" href="https://sinai-adventure.yuk-mari.com/">Sinai Adventure</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: January 14, 2024
								</div>
							</div>
							
							<div class="blog-post-content">
								<h3><a target="_blank" href="https://daftarindihome.co/">Agency Indihome</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								...
								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: June 08, 2024
								</div>
							</div>
							
							<div class="blog-post-content">
								<h3><a target="_blank" href="https://anugerahciptaarsitektur.my.id/">Anugerah Cipta Arsitektur</a></h3>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/sekolah/1.png" alt="image">
								</a>

								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: September 20, 2017
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">SMAN 4 Cimahi Web Quiz</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/sekolah/2.jpg" alt="image">
								</a>
							...
							<div class="blog-post-content">
								<h3><a target="_blank" href="https://assasulislam.yuk-mari.com/">MI Assasul Islam Cianjur</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/sekolah/3.jpg" alt="image">
								</a>
							...
							<div class="blog-post-content">
								<h3><a target="_blank" href="https://phi-ec.yuk-mari.com/">Phi Education Center</a></h3>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/sekolah/4.jpg" alt="image">
								</a>

								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: November 11, 2023
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">TK Abata Islamic School, Cianjur</a></h3>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/mahasiswa/1.jpg" alt="image">
								</a>

								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: Juni 07, 2024
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">Aplikasi Corak Bahasa Sunda</a></h3>
					...
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/mahasiswa/2.jpg" alt="image">
								</a>

								<div class="date">
									<i class="far fa-calendar-alt"></i> Dibuat: Juni 17, 2024
								</div>
							</div>

							<div class="blog-post-content">
								<h3><a href="#">Aplikasi Laundry Multifungsi</a></h3>
				...
				<div class="section-title">
                    <h2>Website Sistem Kasir / Pembayaran</h2>
                    <div class="bar"></div>
                </div>
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-blog-post">
							<div class="blog-image">
								<a href="#">
									<img src="assets/img/blog-image/kasir/1.jpg" alt="image">
								</a>
							...
							<div class="blog-post-content">
								<h3><a href="#">Kasir Warung Nasi SR (Dapoer Catering SR)</a></h3>
